...
Power=pd.read_csv(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Data\Guadalajara_Power.csv')

Power.head()
del Power['DT.1']
Power.index=Power['DT']
mbox=BoxPlot(Power,values='Dollars',label='Month',color='Month', 
             title='Monthly Price Distributions for 2016',plot_width=1200)
mbox.yaxis.axis_label='Dollars per MWh'
mbox.yaxis[0].formatter=NumeralTickFormatter(format="$0.00")

mline=Scatter(data=Power,x='Date',y='Dollars',
                 title='TimeSeries of Guadalajara Node Prices 2016', color='Month',
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output\HistoricPowerTabs.html') 
show(tabsp)
#************************ Load plots ************************#
...
FullAnci=pd.read_csv(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Data\Full_anci.csv')
FullAnci.head()
...
SecScat=Scatter(data=Z1Secondary,x='Date',y='Dollars',color='Month',
                title='Secondary Reserve Prices 2016')
...
Spin10Scat=Scatter(data=Z1Spin10,x='Date',y='Dollars',color='Month',
                   title='10 Minute Spinning Reserve 2016')
...
noSpin10Scat=Scatter(data=Z1noSpin10,x='Date',y='Dollars',color='Month',
                     title='Non-Spinning 10 Minute Reserve 2016')
noSpin10Scat.yaxis.axis_label='Dollars per MWh'
noSpin10Scat.yaxis[0].formatter=NumeralTickFormatter(format="$0.00")

SpinSuppScat=Scatter(data=Z1spinSupp,x='Date',y='Dollars',color='Month',
                     title='Spinning Supplementary Reserve 2016')
SpinSuppScat.yaxis.axis_label='Dollars per MWh'
SpinSuppScat.yaxis[0].formatter=NumeralTickFormatter(format="$0.00")

NoSpinSuppScat=Scatter(data=Z1nospinSupp,x='Date',y='Dollars',color='Month',
                       title='Non-Spinning Supplementary Reserve 2016')
...
SecBox=BoxPlot(Z1Secondary,values='Dollars',color='Month',
                title='Secondary Reserve Prices 2016',label='Month')
...
Spin10Box=BoxPlot(Z1Spin10,values='Dollars',color='Month',
                   title='10 Minute Spinning Reserve 2016',label='Month')
...
SpinSuppBox=BoxPlot(Z1spinSupp,values='Dollars',color='Month',
                     title='Spinning Supplementary Reserve 2016',label='Month')
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output\AnciMonthtype.html')
show(glayout)
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output\GenerationForecast.html')
show(Glayout)
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output\ResultsAnciMonthtype.html')
show(rglayout)
