...
Power_2=pd.read_csv(r"\\ascendanalytics.com\users\sxk94\Mexico\Data\Appended_2017\Power\RT\MexRTPow_2017_thruJun.csv")
Power_2['DT']=pd.date_range(start='1/27/2017', periods=3695, freq='H')
Power_2.index=Power_2['DT']
del Power_2['Unnamed: 0']
#del Power_1['DT.1']
#Power_1.index=Power_1['DT']
#Power=Power_1.append(Power_2)
Power_2['DT']=pd.to_datetime(Power_2['DT'])
Power = Power_2
Power.head()
#del Power['DT.1']
...
secondp=Panel(child=row(tri1s,tri2s),title='Averages')
tabsp=Tabs(tabs=[firstp,secondp])
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output2\PowerRTTabs.html') 
show(tabsp)
#%%
#************************ Load plots ************************#

#**********TimeSeries and BoxPlots***************#
Load=pd.read_excel(r'\\ascendanalytics.com\users\sxk94\Mexico\Data\Appended_2017\Load\Load_updated.xlsx')
Load.head()
del Load['Date.1']
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output2\HistoricLoadTabs2.html')
show(ltabs)
#%%
#******************** Historic Ancilliaries*********************#
#******************** Full time series and boxplot Ancilliaries  **********************#
#FullAnci_2017=pd.read_csv(r"\\ascendanalytics.com\users\sxk94\Mexico\Data\Appended_2017\Acillary\DA\MexDAAnci_2017_thruJun3.csv")
#FullAnci_2016=pd.read_csv(r"\\ascendanalytics.com\users\sxk94\Mexico\Data\Appended\Full_anci.csv")
#FullAnci_2016.columns = ['Index','Hour','Zone','Type','Price','Date']
#FullAnci_2016 = FullAnci_2016[FullAnci_2016['Zone']=='ZONA 1']
#FullAnci_2016['Month'] = FullAnci_2016.Date.apply(lambda x: x[5:7])
#FullAnci_2016['Day'] = FullAnci_2016.Date.apply(lambda x: x[2:4])
#FullAnci_2016['Dollars'] = FullAnci_2016.Price/20
#FullAnci_2016.head(3)
#FullAnci_2017.head(3)

#FullAnci=FullAnci_2017.append(FullAnci_2016)
FullAnci=pd.read_csv(r"\\ascendanalytics.com\users\sxk94\Mexico\Data\Appended_2017\Acillary\RT\MexRTAnci_2017_thruJun.csv")
AnciZ1 = FullAnci[FullAnci['Zone']=='ZONA 1']
#FullAnci.columns=['Index','Hour','Zone','Type','Price','Date']
#AnciZ1=FullAnci[FullAnci['Zone']=='ZONA 1']
#AnciZ1['Month']=AnciZ1.Date.apply(lambda x: x[5:7])
#AnciZ1['Dollars']=AnciZ1.Price/20
#
Z1Secondary=AnciZ1[AnciZ1['Type']=='Reserva de regulacion secundaria']
Z1Secondary['DT']=pd.date_range(start='1/27/2017', periods=3719, freq='H')
Z1Spin10=AnciZ1[AnciZ1['Type']=='Reserva rodante de 10 minutos']
Z1Spin10['DT']=pd.date_range(start='1/27/2017', periods=3719, freq='H')
Z1noSpin10=AnciZ1[AnciZ1['Type']=='Reserva no rodante de 10 minutos']
Z1noSpin10['DT']=pd.date_range(start='1/27/2017', periods=3719, freq='H')
Z1spinSupp=AnciZ1[AnciZ1['Type']=='Reserva rodante suplementaria']
Z1spinSupp['DT']=pd.date_range(start='1/27/2017', periods=3719, freq='H')
Z1nospinSupp=AnciZ1[AnciZ1['Type']=='Reserva no rodante suplementarias']
Z1nospinSupp['DT']=pd.date_range(start='1/27/2017', periods=3719, freq='H')
#%%
SecScat=Scatter(data=Z1Secondary,x='DT',y='Dollars',color='Month',
                title=' RT Secondary Reserve Prices 2017')
...
Spin10Scat=Scatter(data=Z1Spin10,x='DT',y='Dollars',color='Month',
                   title='RT 10 Minute Spinning Reserve 2017')
...
#                     title='RT Non-Spinning 10 Minute Reserve 2017')
...
SpinSuppScat=Scatter(data=Z1spinSupp,x='DT',y='Dollars',color='Month',
                     title='RT Spinning Supplementary Reserve 2017')
...
#                       title='RT Non-Spinning Supplementary Reserve 2017')
...
SecBox=BoxPlot(Z1Secondary,values='Dollars',color='Month',
                title='RT Secondary Reserve Prices 2017',label='Month')
...
Spin10Box=BoxPlot(Z1Spin10,values='Dollars',color='Month',
                   title='RT Minute Spinning Reserve 2017',label='Month')
...
#                     title='Non-Spinning 10 Minute Reserve 2016',label='Month')
...
SpinSuppBox=BoxPlot(Z1spinSupp,values='Dollars',color='Month',
                     title='RT Spinning Supplementary Reserve 2017',label='Month')
...
#                       title='Non-Spinning Supplementary Reserve 2016',label='Month')
...
glayout=gridplot([[SecScat,SecBox],[Spin10Scat,Spin10Box],
                 [SpinSuppScat,SpinSuppBox]])

output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output2\2017AnciRT.html')
show(glayout)
#%%

#********************* Results Data *******************#
Results=pd.read_excel(r'C:\Users\sxk94\Desktop\Mexico\RawModelResultsDA_s.xlsx')
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output\ProjectedNetRevenue.html')
show(Rlayout)
#%%
#Generation
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output2\GenerationForecast.html')
show(Glayout)
#%%
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output2\ResultsAnciMonthtype.html')
show(rglayout)
#%%
#************************Gas******************#
...
output_file(r'\\ascendanalytics.com\users\sxk94\Python\Mexico\Output2\Gasprices.html')
show(Gaslayout)
